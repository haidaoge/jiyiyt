window.onload = function(){
	...
	var aSort = [];
	var aPosition = [
					{width:607,height:336,top:30,left:296,zIndex:10},
					{width:490,height:275,top:53,left:70,zIndex:8},
					...
					{width:490,height:275,top:53,left:640,zIndex:8}
		]
